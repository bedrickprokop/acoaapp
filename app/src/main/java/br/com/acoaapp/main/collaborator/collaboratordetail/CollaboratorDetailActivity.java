...
import br.com.acoaapp.main.commons.components.dialogloader.DialogLoader;
...
public class CollaboratorDetailActivity extends AppCompatActivity implements CollaboratorDetailContract.View {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == MessageConstants.REQUESTCODE_EDITCOLLABORATOR) {
    ...
    private void setupContentView() {
        ...
        if (null != extras) {
            collaboratorCode = (Integer) extras.get(MessageConstants.INTENT_KEY_COLLABORATORCODE);
        }
    ...
    public void showCollaboratorsUi() {
        ...
        intent.putExtra(MessageConstants.INTENT_KEY_RELOAD_COLLABORATORS, reloadCollaborators);
    ...
    public void showAddCollaboratorUi(Collaborator collaborator) {
        ...
        intent.putExtra(MessageConstants.INTENT_KEY_COLLABORATOR, collaborator);
